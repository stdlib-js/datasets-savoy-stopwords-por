...
```javascript
import stopwords from 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-savoy-stopwords-por@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/datasets-savoy-stopwords-por/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/datasets-savoy-stopwords-por/actions/workflows/test.yml?query=branch:v0.2.3
